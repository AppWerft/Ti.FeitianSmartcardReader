  ...
  extends Expression
{
  ...
  public void compile(Compilation comp, Target target) {
    ...
    Target ttarg;
    Target ttarg; if (((target instanceof StackTarget)) || ((target instanceof ConsumerTarget)) || ((target instanceof IgnoreTarget)) || (((target instanceof ConditionalTarget)) && (finally_clause == null)))
    {
    ...
    for (CatchClause catch_clause = catch_clauses; 
        catch_clause != null; catch_clause = catch_clause.getNext())
    {
  ...
  protected <R, D> void visitChildren(ExpVisitor<R, D> visitor, D d)
  {
    ...
    if ((exitValue == null) && (finally_clause != null))
