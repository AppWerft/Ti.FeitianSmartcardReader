  ...
  implements Appendable, XConsumer
{
  ...
  public PrintConsumer(Consumer out, boolean autoFlush) { this((out instanceof Writer) ? (Writer)out : new ConsumerWriter(out), autoFlush);
  ...
  {
    write(csq == null ? "null" : csq, start, end - start);
  ...
  public void beginEntity(Object baseUri) { if (skipping)
      return;
    beforeNode();
    if ((base instanceof XConsumer))
  ...
  public void endEntity() { if (skipping)
      return;
    if ((base instanceof XConsumer))
