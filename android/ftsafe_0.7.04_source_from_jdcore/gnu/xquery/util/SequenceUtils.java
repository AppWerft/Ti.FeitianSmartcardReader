...
public class SequenceUtils
{
  ...
  static Object coerceToZeroOrOne(Object arg, String functionName, int iarg)
  {
    if (isZeroOrOne(arg))
      return arg;
    throw new gnu.mapping.WrongType(functionName, iarg, arg, "xs:item()?");
  }
  ...
  public static boolean deepEqual(NodeTree seq1, int ipos1, NodeTree seq2, int ipos2, NamedCollator collator)
  {
    ...
    case 35: 
      ...
      {
        return false; }
      return deepEqualItems(gnu.kawa.xml.KAttr.getObjectValue(seq1, ipos1), gnu.kawa.xml.KAttr.getObjectValue(seq2, ipos2), collator);
  ...
  public static boolean deepEqual(Object arg1, Object arg2, NamedCollator collator)
  {
    ...
    for (;;)
    {
      ...
      if (((item1 instanceof KNode)) && ((item2 instanceof KNode)))
      {
        ...
        if (!deepEqual((NodeTree)sequence, ipos, (NodeTree)sequence, ipos, collator))
        {
  ...
  {
    subList$C(seq, start, end, consumer);
  }
  ...
  public static void subList$C(Object seq, double start, double end, Consumer out)
  {
    ...
    {
      int istart = (int)(start - 1.0D);
      int iend = (int)(end - 1.0D);
