...
public class Debug
{
  ...
  public static synchronized Object trace(Object value, Object message) { OutPort out = tracePort;
    if (out == null)
    {
      try
      {
        out = new OutPort(new java.io.FileOutputStream(traceFilename, traceShouldAppend));

      }
      catch (Exception ex)
      {
        throw new gnu.mapping.WrappedException("Could not open '" + traceFilename + "' for fn:trace output", ex);
      }
