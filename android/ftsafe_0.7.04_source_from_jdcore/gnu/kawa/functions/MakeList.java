...
public class MakeList extends gnu.mapping.ProcedureN implements gnu.expr.Inlineable
{
  ...
  public static Object list$V(Object[] args)
  {
    ...
    int i = args.length; for (;;) { i--; if (i < 0) break;
      result = new gnu.lists.Pair(args[i], result); }
    return result;
  }
  ...
  {
    return args.length > 0 ? Compilation.typePair : gnu.kawa.lispexpr.LangObjType.listType;
  }
