...
public class UByte extends UnsignedPrim implements Comparable<UByte> { byte ival;
  ...
  public boolean equals(Object obj) {
    return ((obj instanceof UByte)) && (ival == ival);
  }
  ...
  public static String toString(byte ival) { return Integer.toString(ival & 0xFF); }
