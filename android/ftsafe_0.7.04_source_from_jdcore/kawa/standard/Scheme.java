  ...
  extends LispLanguage
{
  ...
  protected static final gnu.mapping.SimpleEnvironment kawaEnvironment = Environment.make("kawa-environment", r6Environment);
  

  public static final Scheme instance = new Scheme(kawaEnvironment);
  public static final Scheme r5rsInstance = newStandardInstance(5);
  public static final Scheme r6rsInstance = newStandardInstance(6);
  public static final Scheme r7rsInstance = newStandardInstance(7);
  
  public static final gnu.kawa.lispexpr.LangPrimType booleanType = new gnu.kawa.lispexpr.LangPrimType(Type.booleanType, instance);
  

  public static final gnu.kawa.functions.ApplyToArgs applyToArgs = new gnu.kawa.functions.ApplyToArgs("apply-to-args", instance);
  
  public static final gnu.kawa.functions.Apply apply = new gnu.kawa.functions.Apply("apply", applyToArgs);
  

  public static final gnu.kawa.reflect.InstanceOf instanceOf = new gnu.kawa.reflect.InstanceOf(instance, "instance?");
  
  public static final gnu.kawa.functions.Not not = new gnu.kawa.functions.Not(instance, "not");
  

  public static final gnu.kawa.functions.IsEq isEq = new gnu.kawa.functions.IsEq(instance, "eq?");
  
  public static final gnu.kawa.functions.IsEqv isEqv = new gnu.kawa.functions.IsEqv(instance, "eqv?", isEq);
  
  public static final gnu.kawa.functions.IsEqual isEqual = new gnu.kawa.functions.IsEqual(instance, "equal?");
  

  public static final gnu.kawa.functions.Map map = new gnu.kawa.functions.Map(true, applyToArgs, isEq);
  
  public static final gnu.kawa.functions.Map forEach = new gnu.kawa.functions.Map(false, applyToArgs, isEq);
  ...
  public static final gnu.kawa.functions.NumberPredicate isOdd = new gnu.kawa.functions.NumberPredicate(instance, "odd?", 1);
  
  public static final gnu.kawa.functions.NumberPredicate isEven = new gnu.kawa.functions.NumberPredicate(instance, "even?", 2);
  

  private static final String[] uniformVectorTags = { "s8", "s16", "s32", "s64", "u8", "u16", "u32", "u64", "f32", "f64" };
  ...
  private static Scheme newStandardInstance(int standardToFollow)
  {
    ...
    standardToFollow = standardToFollow;
    return instance;
  }
  ...
  private void initScheme()
  {
    ...
    defSntxStFld("$resolve-qname$", "gnu.kawa.lispexpr.ResolveNamespace", "resolveQName");
    ...
    defProcStFld("floor-quotient", "gnu.kawa.functions.DivideOp", "floorQuotient");
    ...
    defProcStFld("flush-output-port", "kawa.lib.ports");
    ...
    defProcStFld("call-with-values", "gnu.kawa.functions.CallWithValues", "callWithValues");
    ...
    defAliasStFld("command-line-arguments", "gnu.expr.ApplicationMainSupport", "commandLineArguments");
    ...
    defProcStFld("bit-extract", "kawa.lib.numbers", gnu.expr.Language.mangleNameIfNeeded("bitwise-bit-field"));
    ...
    defSntxStFld("define-rewrite-syntax", "kawa.standard.define_syntax", "define_rewrite_syntax");
    ...
    defSntxStFld("include-relative", "kawa.standard.Include", "includeRelative");
    ...
    defProcStFld(LispLanguage.constructNamespace.getSymbol("cmd"), "kawa.lib.system", "cmd");
    
    defProcStFld(LispLanguage.constructNamespace.getSymbol("`"), "kawa.lib.system", "cmd");
    
    defProcStFld(LispLanguage.constructNamespace.getSymbol("sh"), "kawa.lib.system", "sh");
    ...
    defSntxStFld("define-library", "kawa.standard.define_library", "define_library");
    
    defSntxStFld("define-alias", "kawa.standard.define_alias", "define_alias");
    
    defSntxStFld("define-private-alias", "kawa.standard.define_alias", "define_private_alias");
    ...
    defAliasStFld("array", "gnu.kawa.lispexpr.GenArrayType", "generalInstance");
    ...
    int i = uniformVectorTags.length; for (;;) { i--; if (i < 0)
        break;
      String tag = uniformVectorTags[i];
      defAliasStFld(tag + "vector", "gnu.kawa.lispexpr.LangObjType", tag + "vectorType");
    ...
    defAliasStFld("bytevector", "gnu.kawa.lispexpr.LangObjType", "u8vectorType");
    ...
    defAliasStFld("*print-right-margin*", "gnu.kawa.io.PrettyWriter", "lineLengthLoc");
    
    defAliasStFld("*print-miser-width*", "gnu.kawa.io.PrettyWriter", "miserWidthLoc");
    
    defAliasStFld("*print-circle*", "gnu.kawa.io.PrettyWriter", "isSharing");
    defAliasStFld("*print-xml-indent*", "gnu.xml.XMLPrinter", "indentLoc");
    ...
    defAliasStFld("constant-vector", "gnu.kawa.lispexpr.LangObjType", "constVectorType");
    ...
    defProcStFld(LispLanguage.constructNamespace.getSymbol("PD"), "kawa.lib.files", "PD");
    
    defProcStFld(LispLanguage.constructNamespace.getSymbol("<"), "kawa.lib.files", "PD");
    
    defProcStFld(LispLanguage.constructNamespace.getSymbol(">"), "kawa.lib.files", "set_PD");
    
    defProcStFld(LispLanguage.constructNamespace.getSymbol(">>"), "kawa.lib.files", "append_PD");
    ...
    int withServlets = gnu.kawa.servlet.HttpRequestContext.importServletDefinitions;
    if (withServlets > 0) {
      try {
        loadClass(withServlets > 1 ? "gnu.kawa.servlet.servlets" : "gnu.kawa.servlet.HTTP");
      }
      catch (Exception ex) {}
    }
  }
  ...
  {
    return eval(new gnu.kawa.io.CharArrayInPort(string), env);
  }
  ...
  public static Object eval(gnu.kawa.io.InPort port, Environment env)
  {
    ...
    try
    {
      LispReader lexer = (LispReader)gnu.expr.Language.getDefaultLanguage().getLexer(port, messages);
      
      Object body = gnu.kawa.lispexpr.ReaderParens.readList(lexer, null, 0, 1, -1, -1);
      if (messages.seenErrors())
        throw new gnu.text.SyntaxException(messages);
      return kawa.lang.Eval.evalBody(body, env, messages);
  ...
  public static Object eval(Object sexpr, Environment env)
  {
    try
    {
      return kawa.lang.Eval.eval(sexpr, env);
    }
    catch (Throwable ex)
    {
      throw gnu.mapping.WrappedException.rethrow(ex);
  ...
  {
    return readable ? gnu.kawa.functions.DisplayFormat.schemeWriteFormat : gnu.kawa.functions.DisplayFormat.schemeDisplayFormat;
  }
  ...
  public LispReader getLexer(gnu.kawa.io.InPort inp, SourceMessages messages)
  {
    ...
    if ((reader.getReadCase() == 0) && (standardToFollow == 5))
    {
  ...
  public int getNamespaceOf(gnu.expr.Declaration decl)
  {
    return 3;
  }
  

  public static Type getTypeValue(gnu.expr.Expression exp)
  {
  ...
  {
    if (types == null) {
      types = new HashMap(128);
      types.put("boolean", booleanType);
      types.put("parameter", gnu.expr.Compilation.typeLocationProc);
      types.putAll(super.getTypeMap());
      int i = uniformVectorTags.length; for (;;) { i--; if (i < 0) break;
        String tag = uniformVectorTags[i];
        String cname = "gnu.lists." + tag.toUpperCase() + "Vector";
        types.put(tag + "vector", gnu.bytecode.ClassType.make(cname));
      }
    }
    return types;
  }
  ...
  public String formatType(Type type)
  {
    if ((type instanceof LazyType)) {
      ...
      return formatType(ltype.getRawType()) + '[' + formatType(ltype.getValueType()) + ']';
    }
    
    if ((type instanceof gnu.kawa.reflect.MultValuesType)) {
      gnu.kawa.reflect.MultValuesType mtype = (gnu.kawa.reflect.MultValuesType)type;
  ...
  public static Type exp2Type(gnu.expr.Expression exp)
  {
    return getInstance().getTypeFor(exp);
  }
  
  public gnu.mapping.Symbol asSymbol(String ident)
  {
  ...
  public ReadTable createReadTable()
  {
    ...
    gnu.kawa.lispexpr.ReaderDispatchSyntaxQuote sentry = new gnu.kawa.lispexpr.ReaderDispatchSyntaxQuote();
    ...
    tab.putReaderCtor("symbol", gnu.bytecode.ClassType.make("gnu.mapping.Symbol"));
    tab.putReaderCtor("namespace", gnu.bytecode.ClassType.make("gnu.mapping.Namespace"));
    ...
    if ((std != 5) && (std != 6) && (std != 7))
    {
      ...
      extraFlags = 8;
      tab.set(64, new gnu.kawa.lispexpr.ReaderQuote(LispLanguage.splice_sym, 6));
    }
  ...
  {
    gnu.expr.Language.setDefaults(getInstance());
  }
}
