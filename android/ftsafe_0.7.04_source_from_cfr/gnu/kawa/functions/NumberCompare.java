...
extends ProcedureN {
    ...
    public static boolean apply2(int flags, Object arg1, Object arg2) {
        return (1 << 3 + NumberCompare.compareStrict(arg1, arg2, true) & flags) != 0;
    }
    ...
    public static boolean applyWithPromotion(int flags, Object arg1, Object arg2) {
        return NumberCompare.checkCompareCode(NumberCompare.compareStrict(arg1, arg2, false), flags);
    }
    ...
    public static int compareStrict(Object arg1, Object arg2, boolean exact) {
        int code2;
        int code1 = Arithmetic.classifyValue(arg1);
        int r = NumberCompare.compare(arg1, code1, arg2, code2 = Arithmetic.classifyValue(arg2), exact);
        if (r == -3) {
