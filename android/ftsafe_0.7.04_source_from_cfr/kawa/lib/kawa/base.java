...
extends ModuleBody {
    ...
    public static final StaticFieldLocation environment;
    public static final StaticFieldLocation eval;
    ...
    public static final StaticFieldLocation exact$Mn$Grinexact;
    public static final StaticFieldLocation inexact$Mn$Grexact;
    public static final StaticFieldLocation syntax;
    public static final StaticFieldLocation quasisyntax;
    public static final StaticFieldLocation syntax$Mncase;
    public static final StaticFieldLocation with$Mnsyntax;
    public static final StaticFieldLocation generate$Mntemporaries;
    public static final StaticFieldLocation datum$Mn$Grsyntax;
    public static final StaticFieldLocation syntax$Mn$Grdatum;
    public static final StaticFieldLocation define$Mnsyntax$Mncase;
    public static final StaticFieldLocation identifier$Qu;
    public static final StaticFieldLocation $bracket$Mnapply$;
    public static final StaticFieldLocation $bracket$Mnlist$;
    public static final StaticFieldLocation require;
    public static final StaticFieldLocation import;
    ...
    public static final StaticFieldLocation logop;
    ...
    public static final StaticFieldLocation define$Mnalias;
    public static final StaticFieldLocation define$Mnvariable;
    public static final StaticFieldLocation define$Mnconstant;
    public static final StaticFieldLocation define$Mnearly$Mnconstant;
    public static final StaticFieldLocation define$Mnclass;
    public static final StaticFieldLocation define$Mnsimple$Mnclass;
    public static final StaticFieldLocation object;
    public static final StaticFieldLocation this;
    ...
    public static final StaticFieldLocation try$Mnfinally;
    public static final StaticFieldLocation try$Mncatch;
    public static final StaticFieldLocation synchronized;
    public static final StaticFieldLocation call$Mnwith$Mninput$Mnstring;
    public static final StaticFieldLocation call$Mnwith$Mnoutput$Mnstring;
    public static final StaticFieldLocation force$Mnoutput;
    public static final StaticFieldLocation format;
    public static final StaticFieldLocation make$Mnprocess;
    public static final StaticFieldLocation command$Mnparse;
    public static final StaticFieldLocation runnable;
    public static final StaticFieldLocation future;
    public static final StaticFieldLocation sleep;
    public static final StaticFieldLocation scheme$Mnimplementation$Mnversion;
    public static final StaticFieldLocation reverse$Ex;
    ...
    public static {
        ...
        environment = StaticFieldLocation.make("kawa.lib.scheme.eval", "environment");
        ...
        exact$Mn$Grinexact = StaticFieldLocation.make("kawa.lib.numbers", "exact$Mn$Grinexact");
        inexact$Mn$Grexact = StaticFieldLocation.make("kawa.lib.numbers", "inexact$Mn$Grexact");
        $bracket$Mnapply$ = StaticFieldLocation.make("gnu.kawa.lispexpr.BracketApply", "instance");
        quasisyntax = StaticFieldLocation.make("kawa.standard.syntax", "quasiSyntax");
        syntax = StaticFieldLocation.make("kawa.standard.syntax", "syntax");
        identifier$Qu = StaticFieldLocation.make("kawa.lib.std_syntax", "identifier$Qu");
        with$Mnsyntax = StaticFieldLocation.make("kawa.lib.std_syntax", "with$Mnsyntax");
        generate$Mntemporaries = StaticFieldLocation.make("kawa.lib.std_syntax", "generate$Mntemporaries");
        datum$Mn$Grsyntax = StaticFieldLocation.make("kawa.lib.std_syntax", "datum$Mn$Grsyntax");
        syntax$Mn$Grdatum = StaticFieldLocation.make("kawa.lib.std_syntax", "syntax$Mn$Grdatum");
        $bracket$Mnlist$ = StaticFieldLocation.make("kawa.lib.syntax", "$bracket$Mnlist$");
        define$Mnsyntax$Mncase = StaticFieldLocation.make("kawa.lib.syntax", "define$Mnsyntax$Mncase");
        try$Mnfinally = StaticFieldLocation.make("kawa.lib.syntax", "try$Mnfinally");
        synchronized = StaticFieldLocation.make("kawa.lib.syntax", "synchronized");
        try$Mncatch = StaticFieldLocation.make("kawa.lib.prim_syntax", "try$Mncatch");
        define$Mnconstant = StaticFieldLocation.make("kawa.lib.prim_syntax", "define$Mnconstant");
        define$Mnearly$Mnconstant = StaticFieldLocation.make("kawa.lib.prim_syntax", "define$Mnearly$Mnconstant");
        define$Mnvariable = StaticFieldLocation.make("kawa.lib.prim_syntax", "define$Mnvariable");
        syntax$Mncase = StaticFieldLocation.make("kawa.standard.syntax_case", "syntax_case");
        define$Mnalias = StaticFieldLocation.make("kawa.standard.define_alias", "define_alias");
        require = StaticFieldLocation.make("kawa.standard.require", "require");
        import = StaticFieldLocation.make("kawa.standard.ImportFromLibrary", "instance");
        define$Mnsimple$Mnclass = StaticFieldLocation.make("kawa.standard.define_class", "define_simple_class");
        define$Mnclass = StaticFieldLocation.make("kawa.standard.define_class", "define_class");
        object = StaticFieldLocation.make("kawa.standard.object", "objectSyntax");
        this = StaticFieldLocation.make("kawa.standard.thisRef", "thisSyntax");
        ...
        logop = StaticFieldLocation.make("kawa.lib.numbers", "logop");
        ...
        call$Mnwith$Mninput$Mnstring = StaticFieldLocation.make("kawa.lib.ports", "call$Mnwith$Mninput$Mnstring");
        call$Mnwith$Mnoutput$Mnstring = StaticFieldLocation.make("kawa.lib.ports", "call$Mnwith$Mnoutput$Mnstring");
        force$Mnoutput = StaticFieldLocation.make("kawa.lib.ports", "force$Mnoutput");
        format = StaticFieldLocation.make("gnu.kawa.functions.Format", "format");
        scheme$Mnimplementation$Mnversion = StaticFieldLocation.make("kawa.lib.misc", "scheme$Mnimplementation$Mnversion");
        reverse$Ex = StaticFieldLocation.make("kawa.lib.lists", "reverse$Ex");
        make$Mnprocess = StaticFieldLocation.make("kawa.lib.system", "make$Mnprocess");
        command$Mnparse = StaticFieldLocation.make("kawa.lib.system", "command$Mnparse");
        future = StaticFieldLocation.make("kawa.lib.thread", "future");
        sleep = StaticFieldLocation.make("kawa.lib.thread", "sleep");
        runnable = StaticFieldLocation.make("kawa.lib.thread", "runnable");
        base.$runBody$();
    }
