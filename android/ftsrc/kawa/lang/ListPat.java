...
public class ListPat extends Pattern
{
  ...
  {
    min_length = len;max_length = len; }
  public ListPat(int min, int max) { min_length = min;max_length = max; }
  
  public ListPat(int min, int max, Object default_val) { min_length = min;max_length = max;default_value = default_val;
  }
  ...
  {
    return match(min_length, max_length, default_value, obj, vars, start_vars);
  }
