  ...
  implements SourceLocator
{
  ...
  protected R visitSetExp(SetExp exp, D d) {
    new_value = visitAndUpdate(new_value, d);
    return defaultValue(exp, d);
  }
  ...
  protected R visitReferenceExp(ReferenceExp exp, D d) { return visitExpression(exp, d); }
  
  protected R visitThisExp(ThisExp exp, D d) {
    return visitReferenceExp(exp, d);
  }
  
  protected R visitSynchronizedExp(SynchronizedExp exp, D d) { return visitExpression(exp, d); }
  ...
  protected R visitFluidLetExp(FluidLetExp exp, D d) { return visitLetExp(exp, d); }
  

  protected R visitLangExp(LangExp exp, D d) { return visitExpression(exp, d); }
