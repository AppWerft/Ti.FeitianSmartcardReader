...
public class TimeUtils
{
  ...
  static DateTime coerceToDateTime(String fun, Object value)
  {
    ...
    if (((value instanceof gnu.kawa.xml.KNode)) || ((value instanceof gnu.kawa.xml.UntypedAtomic))) {
      return XTimeType.parseDateTime(gnu.xml.TextUtils.stringValue(value), 126);
    }
    throw new gnu.mapping.WrongType(fun, 1, value, "xs:dateTime");
  }
  ...
  static DateTime coerceToDate(String fun, Object value)
  {
    if (XTimeType.dateType.isInstance(value))
      return (DateTime)value;
    if (((value instanceof gnu.kawa.xml.KNode)) || ((value instanceof gnu.kawa.xml.UntypedAtomic))) {
      return XTimeType.parseDateTime(gnu.xml.TextUtils.stringValue(value), 14);
    }
    throw new gnu.mapping.WrongType(fun, 1, value, "xs:date");
  }
  ...
  static DateTime coerceToTime(String fun, Object value)
  {
    if (XTimeType.timeType.isInstance(value))
      return (DateTime)value;
    if (((value instanceof gnu.kawa.xml.KNode)) || ((value instanceof gnu.kawa.xml.UntypedAtomic))) {
      return XTimeType.parseDateTime(gnu.xml.TextUtils.stringValue(value), 112);
    }
    throw new gnu.mapping.WrongType(fun, 1, value, "xs:time");
  }
  ...
  static Duration coerceToDuration(String fun, Object value)
  {
    ...
    throw new gnu.mapping.WrongType(fun, 1, value, "xs:duration");
  }
  ...
  static gnu.math.IntNum asInteger(int value)
  {
  ...
  static Number getSeconds(DateTime date)
  {
    ...
    if (nanos == 0L)
      return gnu.math.IntNum.make(seconds);
    nanos += seconds * 1000000000L;
    return new BigDecimal(java.math.BigInteger.valueOf(nanos), 9);
  }
  ...
  public static BigDecimal secondsBigDecimalFromDuration(long s, int n)
  {
    ...
    BigDecimal dec = new BigDecimal(java.math.BigInteger.valueOf(ns), scale);
    if (huge)
  ...
  {
    return Duration.makeMinutes(java.util.TimeZone.getDefault().getRawOffset() / 60000);
  }
