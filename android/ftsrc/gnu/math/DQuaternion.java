  ...
  implements Externalizable
{
  ...
  public Quaternion toExact() {
    return new CQuaternion(DFloNum.toExact(real), DFloNum.toExact(imag), DFloNum.toExact(jmag), DFloNum.toExact(kmag));
  }
  ...
  public boolean equals(Object obj)
  {
    ...
    return (y.unit() == Unit.Empty) && (Double.doubleToLongBits(real) == Double.doubleToLongBits(y.reValue())) && (Double.doubleToLongBits(imag) == Double.doubleToLongBits(y.imValue())) && (Double.doubleToLongBits(jmag) == Double.doubleToLongBits(y.jmValue())) && (Double.doubleToLongBits(kmag) == Double.doubleToLongBits(y.kmValue()));
  }
  ...
  public String toString()
  {
    ...
    if ((Double.doubleToLongBits(imag) == 0L) && (Double.doubleToLongBits(jmag) == 0L) && (Double.doubleToLongBits(kmag) == 0L))
    {
    ...
    if (Double.doubleToLongBits(jmag) != 0L) {
    ...
    if (Double.doubleToLongBits(kmag) != 0L) {
  ...
  public Numeric add(Object y, int k) {
    if ((y instanceof Quaternion)) {
      ...
      return Quaternion.make(real + k * yq.reValue(), imag + k * yq.imValue(), jmag + k * yq.jmValue(), kmag + k * yq.kmValue());
    }
  ...
  public Numeric mul(Object y) {
    if ((y instanceof Quaternion)) {
      ...
      if (yq.unit() == Unit.Empty) {
        ...
        return Quaternion.make(real * y_re - imag * y_im - jmag * y_jm - kmag * y_km, real * y_im + imag * y_re + jmag * y_km - kmag * y_jm, real * y_jm - imag * y_km + jmag * y_re + kmag * y_im, real * y_km + imag * y_jm - jmag * y_im + kmag * y_re);
      }
  ...
  public Numeric div(Object y) {
    if ((y instanceof Quaternion)) {
      Quaternion yq = (Quaternion)y;
      return div(real, imag, jmag, kmag, yq.doubleValue(), yq.doubleImagValue(), yq.doubleJmagValue(), yq.doubleKmagValue());
    }
  ...
  {
    if ((x_jm == 0.0D) && (x_km == 0.0D) && (y_jm == 0.0D) && (y_km == 0.0D)) {
      return DComplex.power(x_re, x_im, y_re, y_im);
    }
    if ((x_re == 0.0D) && (x_im == 0.0D) && (x_jm == 0.0D) && (x_km == 0.0D)) {
      if (y_re > 0.0D)
  ...
  public static Quaternion sqrt(double x_re, double x_im, double x_jm, double x_km)
  {
    ...
    double s = Math.sin(t / 2.0D);
    
    return Quaternion.make(y_mag * Math.cos(t / 2.0D), y_mag * s * x_im / vmag, y_mag * s * x_jm / vmag, y_mag * s * x_km / vmag);
  }
